...
export function validateExpo(data, cs = "post") {
  const schema = Joi.object({
    ...
    desc_en: Joi.string().allow(null, ""),
    desc_fr: Joi.string().allow(null, ""),
    text_en: Joi.string().allow(null, ""),
    text_fr: Joi.string().allow(null, ""),
    desc_after_en: Joi.string().allow(null, ""),
    desc_after_fr: Joi.string().allow(null, ""),
    text_after_en: Joi.string().allow(null, ""),
    text_after_fr: Joi.string().allow(null, ""),
